...
//        p1.setOwnerName(propertyDTO.getOwnerName());
    ...
    public PropertyDTO convertEntitytoDTO(PropertyEntity propertyEntity){
        ...
        p1.setOnwerEmail(propertyEntity.getUserEntity().getEmail());
        p1.setOwnerName(propertyEntity.getUserEntity().getFirstName() + " " + propertyEntity.getUserEntity().getLastName());
